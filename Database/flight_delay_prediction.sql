...
--
-- Host: localhost
-- Generation Time: Jan 20, 2021 at 12:39 PM
...
--
-- Database: `flight_delay_prediction`
--
CREATE DATABASE IF NOT EXISTS `flight_delay_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `flight_delay_prediction`;
...
--
-- Table structure for table `remote_user_flight_delay_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_flight_delay_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Departure_Country` varchar(300) NOT NULL,
  `Departure_Airport` varchar(300) NOT NULL,
  `Flight_Name` varchar(300) NOT NULL,
  `names` varchar(300) NOT NULL,
  `Date` varchar(300) NOT NULL,
  `Departure_Scheduled_Time` varchar(300) NOT NULL,
  `Pre_Flight` varchar(300) NOT NULL,
  `Historical_Flight_Delay` varchar(300) NOT NULL,
  `Total_Flight_Delay` varchar(300) NOT NULL,
  `Arrival_Country` varchar(300) NOT NULL,
  `Arrival_Airport` varchar(300) NOT NULL,
  `Airport_Delay_Reason` varchar(300) NOT NULL,
  `Air_Route_Delay_Reason` varchar(300) NOT NULL,
  `Other_Reason` varchar(300) NOT NULL,
  `Expected_Delay` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `remote_user_flight_delay_prediction_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_flight_delay_prediction_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Departure_Country` varchar(300) NOT NULL,
  `Departure_Airport` varchar(300) NOT NULL,
  `Flight_Name` varchar(300) NOT NULL,
  ...
  `Departure_Scheduled_Time` varchar(300) NOT NULL,
  `Pre_Flight` varchar(300) NOT NULL,
  `Historical_Flight_Delay` int(10) NOT NULL,
  `Arrival_Country` varchar(300) NOT NULL,
  `Arrival_Airport` varchar(300) NOT NULL,
  `Airport_Delay_Reason` varchar(300) NOT NULL,
  `Air_Route_Delay_Reason` varchar(300) NOT NULL,
